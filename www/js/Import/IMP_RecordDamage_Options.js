        ...
        $.ajax({
            ...
            success: function (Result) {
                ...
                $(xmlDoc).find('Table8').each(function (index) {
                    ...
                    //html7 += '</div>';
                    html7 += '<tr>';
                    html7 += '<td><label class="checkbox-inline"><input onchange="onChangeCheckonTextContainer();"  type="checkbox" id="' + REFERENCE_DATA_IDENTIFIER + '">' + REFERENCE_DESCRIPTION + '</label></td>';
                    html7 += '<td><input disabled="disabled" type="number" id="' + REFERENCE_DATA_IDENTIFIER + '" class="form-control checkontextContainer"></td>';
                    html7 += '</tr>';

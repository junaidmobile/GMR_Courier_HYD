...
function GetFlightDetails() {
    ...
    if (errmsg == "" && connectionStatus == "online") {
        $.ajax({
            type: "POST",
            url: GHAImportFlightserviceURL + "GetImportFlightDetailsV4",
            data: JSON.stringify({
                'InputXML': inputxml,
            }),
                ...
                $(xmlDoc).find('Table1').each(function (index) {
                    if (index == 0) {
                        ...
                        if (flightSeqNo == 0) {
                            ...
                            $('#lblFlightStatus').text('Flight not found!').css('color', 'red');
                            return;
                        }
                        else
                        ...
                        _finNPR = $(this).find('NPR').text();
                        _finNPX = $(this).find('NPX').text();

...
function RedirectPage(pagename) {
    ...
    if (pagename == 'IMP_Detention.html' && window.localStorage.getItem("RoleIMPDetention") == '0') {
        $.alert('You are not authorized to view this page');
        return;
    }
    else if (pagename == 'IMP_Detention.html')
        window.location.href = pagename

    if (pagename == 'IMP_GenerateBarcode.html' && window.localStorage.getItem("RoleIMPDetention") == '0') {
        $.alert('You are not authorized to view this page');
        return;
    }
    else if (pagename == 'IMP_GenerateBarcode.html')
        window.location.href = pagename
